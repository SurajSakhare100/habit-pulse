     ...
     <div className="">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-20">
          <div className="pb-12 text-center ">
            ...
            <svg viewBox="0 0 68 77" xmlns="http://www.w3.org/2000/svg" className="w-10 h-12 fill-current -scale-x-100 pt-3 text-primary -rotate-180 md:block hidden">
            ...
            <p className  ="font-medium text-md text-primary animate-wiggle mt-6 md:block hidden">Start now...</p></div>
